...
### Simulation
![alt text](<스크린샷 2025-09-03 120143.png>)

### Event 추가
![alt text](<../../../assets/img/CPU/APB3/스크린샷 2025-09-03 124452.png>)
아래 과제에서는 다음과 같이 수정함 (event 하나 삭제)
![alt text](<../../../assets/img/CPU/APB3/스크린샷 2025-09-03 125701.png>)
