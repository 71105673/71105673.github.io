...
module tb_VGA ();
    ...
    string sourcefileName = "Son_640x480.bmp";
    ...
    task ReadBMP();
        ...
        $display("[%s] bmp image offset : %0d", sourcefileName, bmp_data_offset);
        ...
        $display("[%s] bmp image %0d x %0d", sourcefileName, bmp_width, bmp_height);  
...
### 성공
![alt text](<../../../assets/img/VGA/day-2/스크린샷 2025-09-09 161454.png>)
![alt text](../../../assets/img/VGA/day-2/target_640x480.bmp)


## 추후 진행사항 -> CAM 이용
![alt text](<../../../assets/img/VGA/day-2/스크린샷 2025-09-09 165220.png>)